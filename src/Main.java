public class Main {
    public static void main(String[] args) {
        ...
        int value6 = 27897;
        byte value7 = 67;
        System.out.println("число " + value1 + " является типу переменной double");
        System.out.println("число " + value2 + " является типу переменной long");
        System.out.println("число " + value3 + " является типу переменной float");
        System.out.println("число " + value4 + " является типу переменной short");
        System.out.println("число " + value5 + " является типу переменной short");
        System.out.println("число " + value6 + " является типу переменной int");
        System.out.println("число " + value7 + " является типу переменной byte");
